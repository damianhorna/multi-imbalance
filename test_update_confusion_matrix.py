...
class TestUpdateConfusionMatrix(TestCase):
    ...
    def test_update_confusion_matrix(self):
        ...
        my_vars.conf_matrix = bracid.update_confusion_matrix(examples[0], rules[0], positive_class, class_col_name,
                                                      my_vars.conf_matrix)  # TP
        my_vars.conf_matrix = bracid.update_confusion_matrix(examples[1], rules[0], positive_class, class_col_name,
                                                      my_vars.conf_matrix)  # FP
        my_vars.conf_matrix = bracid.update_confusion_matrix(examples[2], rules[1], positive_class, class_col_name,
                                                      my_vars.conf_matrix)  # FN
        my_vars.conf_matrix = bracid.update_confusion_matrix(examples[3], rules[1], positive_class, class_col_name,
