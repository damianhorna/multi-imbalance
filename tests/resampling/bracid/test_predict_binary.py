...
class TestPredict(TestCase):
    ...
    def test_predict_covered(self):
        ...
        test_set = pd.DataFrame({"B": [1, 1, 4, 1.5, 0.5, 0.75],
                                 "C": [3, 2, 1, .5, 3, 2],
                                 "Class": ["", "", "", "", "", ""]})
        ...
        correct = pd.DataFrame(
            {
                my_vars.PREDICTED_LABEL:[_1, _1, _0, _1, _1, _1],
                my_vars.PREDICTION_CONFIDENCE: [0.9, 0.6, 0.875, 0.683333, 0.9, 0.6]
            })
    ...
    def test_predict_uncovered(self):
        ...
        correct = pd.DataFrame(
            {
                my_vars.PREDICTED_LABEL: [_0, _0, _0, _1, _1, _1],
                my_vars.PREDICTION_CONFIDENCE: [0.75, 1, 0.75, 0.9, 0.9, 0.9]
            })
    ...
    def test_predict_mixed(self):
        ...
        correct = pd.DataFrame(
            {
                my_vars.PREDICTED_LABEL: [_0, _1, _0, _1, _1, _1],
                my_vars.PREDICTION_CONFIDENCE: [0.75, 0.6, 0.75, 0.9, 0.9, 0.9]
            })
