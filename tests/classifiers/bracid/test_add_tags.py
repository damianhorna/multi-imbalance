...
class TestAddTags(TestCase):
    ...
    def test_add_tags_noisy_safe(self):
        ...
        df = pd.DataFrame({"B": [1, 1, 4, 1.5, 0.5, 0.75], "C": [3, 2, 1, 0.5, 3, 2], "Class": [_0, _1, _1, _1, _1, _1]})
        class_col_name = "Class"
        k = 3
        bracid = BRACID(k=k, minority_class=-1)
        correct = pd.DataFrame(
    ...
    def test_add_tags_nan(self):
        ...
        df = pd.DataFrame({"B": [np.NaN, 1, np.NaN, 1.5, np.NaN, 0.75], "C": [3, 2, 1, 0.5, 3, 2], "Class": [_0, _0, _1, _1, _1, _1]})
        k = 3
        bracid = BRACID(k=k, minority_class=-1)
