...
class TestTrain(TestCase):
    ...
    def test_train(self):
        ...
        training_set = pd.DataFrame({"B": [1, 1, 4, 1.5, 0.5, 0.75], "C": [3, 2, 1, 0.5, 3, 2], "Class": [_0, _0, _1, _1, _1, _1]})
        ...
        correct_model = {
            2: Support(minority=1.0, majority=0.0),
            6: Support(minority=0.6, majority=0.4),
            5: Support(minority=0.6666666666666666, majority=0.33333333333333337),
