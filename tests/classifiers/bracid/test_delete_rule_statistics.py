...
class TestDeleteRuleStatistics(TestCase):
    ...
    def test_delete_rule_statistics_unique_hash(self):
        ...
        extra_rule = pd.Series({"B": Bounds(lower=0.1, upper=1), "C": Bounds(lower=1, upper=2), "Class": _0}, name=4)
        rules = [
            extra_rule,
        ...
        df = pd.DataFrame({"B": [1, 1, 4, 1.5, 0.5, 0.75], "C": [3, 2, 1, 0.5, 3, 2], "Class": [_0, _0, _0, _0, _0, _0]})
