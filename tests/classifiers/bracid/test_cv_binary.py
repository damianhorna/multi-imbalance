...
class TestCv(TestCase):
    ...
    def test_cv(self):
        ...
        dataset = pd.DataFrame({"B": [1, 1, 4, 1.5, 0.5, 0.75], "C": [3, 2, 1, 0.5, 3, 2], "Class": [_0, _0, _1, _1, _1, _1]})
        ...
        folds = 2
        seed = 135
        micro_f1, classwise_f1 = bracid.cv_binary(dataset, k, class_col_name, min_max, classes, minority_label, folds=folds, seed=seed)
